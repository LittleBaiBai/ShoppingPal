...
angular.module('ShoppingPal', ['ionic', 'ShoppingPal.controllers', 'ShoppingPal.services'])
        ...
        .config(function ($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider
                    ...
                    .state('tab.addShopping', {
                        ...
                        views: {
                            'tab-shoppings': {
                                templateUrl: 'templates/add-shopping.html',
                                controller: 'AddShoppingCtrl'
                            }
                        }
                    })
                    ;
            ...
            $urlRouterProvider.otherwise('/tab/wishes');
